                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      >
                        <div
                          className={`absolute top-1 left-1 w-4 h-4 bg-[var(--background)] rounded-full transition ${(taste.lifestyle[mode as keyof typeof taste.lifestyle] ?? {}).dishwashingAvoid ? "translate-x-6" : ""}`}
                        />
                      </button>
                    </div>
                  </div>
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <div
                className={`w-11 h-6 rounded-full transition-colors duration-200 ${aiMessageEnabled ? "bg-[var(--accent)]" : "bg-gray-300 dark:bg-gray-600"
                  }`}
              />
              <div
                className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform duration-200 ${aiMessageEnabled ? "translate-x-5" : "translate-x-0.5"
                  }`}
              />
            </div>
          </div>
