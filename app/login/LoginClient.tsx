          ...
          {step === "password_email" && (
            ...
            >
              ...
              <div className="relative">
                <input
                  className="w-full input rounded-lg border px-3 py-2 pr-10 text-sm"
                  placeholder="パスワード"
                ...
                <button
                  ...
                  className="absolute right-2 top-2/4 -translate-y-2/4 p-1 hover:text-accent transition-colors"
                >
                  {showPassword ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
