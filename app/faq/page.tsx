...
const faqs = [
  ...
  },
  {
    ...
    answer: "食材の在庫管理、賞味期限の自動通知、AIによる献立生成、レシート読み取り、バーコードスキャンでの自動登録、買い物リスト作成、そしてProプランでは家族との冷蔵庫共有などが可能です。",
    category: "機能",
  },
  {
  ...
  {
    question: "バーコードスキャンで登録できますか？",
    answer: "はい、商品のバーコードを読み取るだけで、商品名や賞味期限を自動で取得・登録できます。数万点の国内商品データベースに対応しており、入力の手間をほとんどゼロにします。",
    category: "使い方",
  },
  {
