...
const features = [
  ...
  },
  {
    id: "barcode-scanning",
    title: "バーコードスキャン",
    description: "商品のバーコードをスキャンするだけで、商品名や賞味期限を自動で取得します。何万点もの国内商品データに対応し、手入力をゼロにします。",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    iconBg: "bg-[var(--semantic-purple-bg)] text-[var(--semantic-purple)]",
    details: [
      "カメラで「ピッ」とやるだけ",
      "特許レベルの爆速検索エンジン",
      "賞味期限を自動で推定",
