...
const steps = [
  {
    number: 1,
    title: "食材を登録",
    description: "冷蔵庫にある食材を登録します。レシート撮影や画像認識で、入力の手間を最小限に抑えられます。",
    details: [
      "レシート読み取り: 複数の食材を一括登録",
      "画像認識: 食材の写真から自動認識",
      "手動入力: 自由な名前で登録"
  ...
  },
  {
    number: 2,
    title: "AIが献立を生成",
    description: "登録された食材情報をもとに、AIが最適な献立を2案＋サジェストで提案します。栄養バランスや好みを考慮します。",
    details: [
      "食材の組み合わせを考慮",
      "栄養バランスを考慮",
      "好みの味付けに対応",
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-[var(--semantic-indigo-bg)] rounded-xl">
                      ...
                      <p className="text-[var(--color-text-secondary)]">
                        {currentStep === 1 && "レシート読み取り機能を使うと、買い物した食材を一括で登録できます。画像認識機能も活用して、楽々登録しましょう。"}
