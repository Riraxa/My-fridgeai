    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl pb-32">
        <div className="flex items-center gap-3 mb-6">
          <button
            onClick={() => {
              // Navigate back to the menu generation page
        ...
        <div className={`${theme === 'dark' ? 'bg-surface-bg border-surface-border' : 'bg-[var(--background)] border-gray-200'} rounded-xl shadow-sm border p-8 text-center`}>
        ...
        <div className="space-y-8">
          <div className="grid md:grid-cols-2 gap-4">
            {weeklyPlan.weeklyMenus.map((day, i) => (
              <div
                key={i}
                className={`${theme === 'dark' ? 'bg-surface-bg border-surface-border' : 'bg-[var(--background)] border-gray-200'} rounded-lg shadow-sm border p-4 relative overflow-hidden`}
              >
          ...
          <div className={`${theme === 'dark' ? 'bg-green-900/20 border-green-800' : 'bg-green-50 border-green-100'} rounded-xl p-6 border`}>
            ...
            <div className={`${theme === 'dark' ? 'bg-surface-bg' : 'bg-[var(--background)]'} rounded-lg p-4 shadow-sm`}>
